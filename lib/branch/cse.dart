...
import 'package:flutter_application_1/timetable/cse/csett.dart';
import 'package:flutter_application_1/timetable/cse/time_tablecse.dart';
    ...
    return MaterialApp(
        ...
        home: Scaffold(
          ...
          appBar: AppBar(
            ...
            centerTitle: true,
            title: const Text("CSE Dept. Dashboard"),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const TimeTableCSE()));
                  },
                  child: Container(
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const CSEtt()));
                  },
                  child: Container(
                    alignment: Alignment.center,
                    height: 56,
